...
class TrainFnPackageBasedRunInstructions(JobSpecModifier):
    ...
    def __init__(
        ...
        train_function_import_string = packages.get_import_string_of_function_or_type(train_fn)
        train_params_type_import_string = packages.get_import_string_of_function_or_type(train_params_type)
